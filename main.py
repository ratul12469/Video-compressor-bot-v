...
# --- CONFIGURATION ---
API_ID = int(os.getenv("API_ID", "39396720"))
API_HASH = os.getenv("API_HASH", "945f0314b982ab0847fd009e5e447b64")
BOT_TOKEN = os.getenv("BOT_TOKEN", "8754712527:AAE2UyTqJLHq-kkYQ1ulRV5ZWCvmAHrY_8c")
